...
--
-- Name: elements elements_name_unique_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_name_unique_key UNIQUE (name);
...
--
-- Name: elements elements_symbol_unique_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT elements_symbol_unique_key UNIQUE (symbol);
...
--
-- Name: properties fk_properties_elements_atomic_number; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properties_elements_atomic_number FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
